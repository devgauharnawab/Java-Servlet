...
<html>
    ...
    <body>
        ...
        <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <!-- cards -->
            <div class="container">
                <h2 class="text-center">Learn The Document</h2>
            </div>
        ...
        <div class="modal fade" id="signupModal" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form>
                        <img src="https://img.freepik.com/free-vector/hand-drawn-case-study-illustration_23-2149082710.jpg?w=2000" alt="Image description" class="img-fluid" style="height: 150px; width: 150px; ">
                        <div class="modal-body">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="cityscroll">
                                    <option value="city">Siwan</option>
                                    <option value="city">patna</option>
                                    <option value="city">Lucknow</option>
                                    <option value="city">Gorakhpur</option>
                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 text-md-right">
                                                <p class="mb-0">Copyright 2023 
                                                    <a href="#">gauharnawab</a>. All rights reserved.</p>
                                                <p class="mb-0"><a href="#">Privacy Policy</a> | <a href="#">Terms of Use</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </footer>
