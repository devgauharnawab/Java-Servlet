            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="http://localhost:8080/elearningproject/c/?action=model&page=LoginModel">
                    ...
                    <form action="http://localhost:8080/elearningproject/c/?action=model&page=LoginModel" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="sumbit" class="btn btn-primary btn-lg btn-block">Submit</button>
                                </div>
